        ...
        if (!$stmt) {
            ...
            if ($result->num_rows === 0) {
                ...
                if (!$update) {
                    ...
                    $message =
                        "Calendar update preparation failed.";
                    ...
                    if ($update->execute()) {
                        ...
                        $message =
                            "Calendar START TIME and END TIME saved successfully.";
